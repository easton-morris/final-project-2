...
INSERT INTO users ("username", "hashPassword", "email") VALUES
  ('admin', '$argon2id$v=19$m=4096,t=3,p=1$gUmbOml7TV0If0A9qhEjGw$qWXvp7bKNQTvIfPFaKpNZiCp0q5nX3jQ0iu41xJg+VM', 'bob@example.co');
